...
public class WeeklyDBHelper extends SQLiteOpenHelper {

    public static final String DATEBASE_NAME = "weeklist.db";
    public static final int DATABASE_VERSION = 1;

    public WeeklyDBHelper(@Nullable Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_WEEKSLIST_TABLE = "CREATE TABLE " +
                WeeklyContract.WeeklyEntry.TABLE_NAME + " (" +
    ...
    public Cursor alldata() {
        ...
        Cursor cursor = db.rawQuery("select * from weeklist", null);
        return cursor;
    }
